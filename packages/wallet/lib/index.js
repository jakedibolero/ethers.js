...
var Bls = require('../../../misc/src/blsBundle');
var logger = new logger_1.Logger(_version_1.version);
function isAccount(value) {
  return (
    value != null &&
    (0, bytes_1.isHexString)(value.privateKey, 32) &&
    value.address != null
  );
}
...
var Wallet = /** @class */ (function (_super) {
  ...
  function Wallet(privateKey, provider) {
    ...
    if (isAccount(privateKey)) {
      ...
      (0, properties_1.defineReadOnly)(
        _this,
        'address',
        (0, transactions_1.computeAddress)(_this.publicKey)
      );
      ...
      if (hasMnemonic(privateKey)) {
        ...
        var node = hdnode_1.HDNode.fromMnemonic(
          mnemonic.phrase,
          null,
          mnemonic.locale
        ).derivePath(mnemonic.path);
        if (
          (0, transactions_1.computeAddress)(node.privateKey) !== _this.address
        ) {
          logger.throwArgumentError(
  ...
  Wallet.prototype.signTransaction = function (transaction) {
    ...
    return (0, properties_1.resolveProperties)(transaction).then(function (tx) {
      ...
      var signature = _this
        ._signingKey()
        .signDigest(
          (0, keccak256_1.keccak256)((0, transactions_1.serialize)(tx))
        );
      ...
      return __generator(this, function (_a) {
        return [
          ...
          (0, bytes_1.joinSignature)(
            this._signingKey().signDigest((0, hash_1.hashMessage)(message))
          ),
        ];
      });
    });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              hash_1._TypedDataEncoder.resolveNames(
                domain,
                types,
                value,
                function (name) {
  ...
  Wallet.prototype.encrypt = function (password, options, progressCallback) {
    ...
    return (0, json_wallets_1.encryptKeystore)(
      this,
      password,
      options,
      progressCallback
  ...
  Wallet.createRandom = function (options) {
    ...
    if (options.extraEntropy) {
      entropy = (0, bytes_1.arrayify)(
        (0, bytes_1.hexDataSlice)(
          (0, keccak256_1.keccak256)(
            (0, bytes_1.concat)([entropy, options.extraEntropy])
          ),
          0,
          16
        )
  ...
  Wallet.decryptPrivateKey = async function (
    cipherparams,
    ciphertext,
    password,
    salt
  ) {
    return await Bls.decryptPrivateKey(
      cipherparams,
      ciphertext,
      password,
      salt
  ...
  Wallet.fromEncryptedJson = function (json, password, progressCallback) {
    return (0, json_wallets_1.decryptJsonWallet)(
      json,
      password,
      progressCallback
  ...
  Wallet.fromEncryptedJsonSync = function (json, password) {
    return new Wallet(
      (0, json_wallets_1.decryptJsonWalletSync)(json, password)
    );
  };
...
function verifyMessage(message, signature) {
  return (0, transactions_1.recoverAddress)(
    (0, hash_1.hashMessage)(message),
    signature
  );
}
...
function verifyTypedData(domain, types, value, signature) {
  return (0, transactions_1.recoverAddress)(
    hash_1._TypedDataEncoder.hash(domain, types, value),
    signature
  );
}
